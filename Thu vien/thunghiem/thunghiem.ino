...
const unsigned long thoi_gian_bo_qua_mat_line = 500; // THÊM: 0.5s để xe lướt qua chỗ rách line
...
const int BU_ZONE_123 = 70;   const float Kp_123 = 70.0;  const float Kd_123 = 100.0;
...
const float Ki = 0.01;
const float TIME_VAO_CUA = 230.0; 
...
bool KiemTraAnToan() {
    ...
    else if (mat_line) 
    {
        ...
        if (dang_gap_su_co) {
            ...
            KhoiTaoThongSoDeBa(); // Reset tốc độ để đề ba êm ái
        }
        return false;
    }
}
